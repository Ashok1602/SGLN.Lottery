...
import AddDistanceTrainingModel from "./AddDistanceTraining";
import { confirmPermissions } from '../../../helpers';

function DistanceTrainingList() {
  ...
  const [updateTrainingModel, setUpdateTrainingModel] = useState(false);
        ...
        Cell: (row) => {
          ...
          return (
            <>
              ...
              &ensp;
              {confirmPermissions("CanEditLiveTraining") &&<button
                type="button"
  ...
  const handleViewModel = () => {
    setUpdateTrainingModel(false);
    setIsView(false);
  };
  return (
    <>
      {addTrainingModel && (
        <AddDistanceTrainingModel
          isOpen={addTrainingModel}
          handleModal={setAddTrainingModel}
          callApi={callApi}
          title={TRANSLATE.t("TRAININGS.ADD_DISTANCE_TRAINING")}
          apiType="get"
          eventType="add"
        />
      )}
      ...
      <div className="mx-3">
        <Card className="top-margin">
          <CardHeader>
            <h1>{TRANSLATE.t("TRAININGS.DISTANCE_TRAINING")}</h1>
            {confirmPermissions("CanCreateLiveTraining") && <Button
              color="primary"
              size="lg"
              onClick={() => {
                setAddTrainingModel(true);
              }}
            >
...
export default DistanceTrainingList;
